...
export const gamePromptForm: HTMLFormElement | null = document.querySelector(
  "#input-controls form"
);
export const gamePromptFormInput: HTMLInputElement = document.querySelector(
  "#input-controls form input"
)!;
